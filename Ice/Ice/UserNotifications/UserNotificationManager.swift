    ...
    func requestAuthorization() {
        Task {
            do {
                ...
                Bridging.Logger.userNotifications.error("Failed to request authorization for notifications: \(error)")
            }
        }
    }
...
private extension Bridging.Logger {
    static let userNotifications = Bridging.Logger(category: "UserNotifications")
}
