...
enum IceDefaults {
    ...
    static func object(forKey key: IceDefaultsKey) -> Any? {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func string(forKey key: IceDefaultsKey) -> String? {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func array(forKey key: IceDefaultsKey) -> [Any]? {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func dictionary(forKey key: IceDefaultsKey) -> [String: Any]? {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func data(forKey key: IceDefaultsKey) -> Data? {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func stringArray(forKey key: IceDefaultsKey) -> [String]? {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func integer(forKey key: IceDefaultsKey) -> Int {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func float(forKey key: IceDefaultsKey) -> Float {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func double(forKey key: IceDefaultsKey) -> Double {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func bool(forKey key: IceDefaultsKey) -> Bool {
    ...
    /// - Parameter key: The key in the UserDefaults database
    ///   to retrieve the value for.
    static func url(forKey key: IceDefaultsKey) -> URL? {
    ...
    static func set(_ value: Any?, forKey key: IceDefaultsKey) {
    ...
    static func removeObject(forKey key: IceDefaultsKey) {
        UserDefaults.standard.removeObject(forKey: key.rawValue)
    }

    /// Retrieves the value for the given key, and, if it is
    /// present, assigns it to the given `inout` parameter.
    static func ifPresent<Value>(key: IceDefaultsKey, assign value: inout Value) {
    ...
    static func ifPresent<Value>(key: IceDefaultsKey, body: (Value) throws -> Void) rethrows {
        if let found = object(forKey: key) as? Value {
            try body(found)
        }
    }
...
enum IceDefaultsKey: String {
    ...
    case expectedHiddenItems = "ExpectedHiddenItems"
    case enableNotchHiddenListMode = "EnableNotchHiddenListMode"
